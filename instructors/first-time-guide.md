...
Further instructor materials are planned for this repository: a worked example of redesigning one course across a full semester, reusable assignment patterns that build in verification and disclosure, models for assessing genuine competence when AI is available, and answers to the questions instructors raise most often. This guide will link to them as they are added.
