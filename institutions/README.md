...
A chair or dean starting from nothing should read the adoption kit first, then run the self-audit to
see what the institution already covers and what it does not.

| Material | What it is |
|---|---|
| [department-adoption-kit.md](department-adoption-kit.md) | The day-one toolset for a chair: a model departmental policy statement, the shared vocabulary, the four assignment categories, the five syllabus questions, and a one-semester rollout |
